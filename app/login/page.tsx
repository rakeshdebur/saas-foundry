...
export default function LoginPage() {
  ...
  const handleDemoLogin = () => {
    setEmail("rakesh.debur@gmail.com")
    setPassword("demopassword")
    setIsLoading(true)

    // Simulate API call
    setTimeout(() => {
      // Store a flag in localStorage to indicate this is a demo login
      localStorage.setItem("saasFoundry_demoUser", "true")
      localStorage.setItem("saasFoundry_demoTools", JSON.stringify(true))
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Access your SaaSFoundry account</CardDescription>
          </CardHeader>
                ...
                <CardContent className="space-y-4 pt-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/forgot-password" className="text-xs text-purple-700 hover:text-purple-800">
                        Forgot password?
                      </Link>
                    </div>
                    <Input
